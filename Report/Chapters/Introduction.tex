...
At the library of Norrköping, three main outer tasks can be identified as working in the expedition desk, working in the information desk and assembling books from the "fetch list" (sv. plocklista). Table \ref{Outer_Tasks} describes the properties of theses tasks.

\begin{table}[h]
\centering
\caption{Outer Tasks}
\label{Outer_Tasks}
\begin{tabular}[10pt]{|l|l|}
\hline
%-------------------------------------------------------------------
\large{\textbf{Task}} & \large{\textbf{Description} }
\\ \hline 
%------------------------------------------------------------------- 
Expedition Desk (Exp) & \specialcelltwo{Handles questions about loans, \\ loan cards and the loaning machine.\\Any library worker can be assigned here.}
%\begin{tabular}[x]{@{}c@{}}\\\end{tabular}  
\\ \hline
%-------------------------------------------------------------------
Information Desk (Info) & \specialcell{Handle questions about the library's resources.\\Only librarians are qualified for this task.}
\\ \hline 
%-------------------------------------------------------------------
Fetch List (FL) & \specialcelltwo{Books which need to be fetched \\ and sent to other libraries.\\All workers are qualified for this task} 
\\ \hline 
%-------------------------------------------------------------------
\end{tabular}
\end{table} 
...
\subsection{External activities: Hageby and Library on Wheels}
