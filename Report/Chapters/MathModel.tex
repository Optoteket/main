...
The constraints modeling department meetings are somewhat similar to the library meetings. Just as for library meetings they take place two times with a five-week interval, which is described by Equation \ref{constr:dep_meetings} and \ref{constr:dep_meetings2}.
...
\end{equation}
Equation \ref{constr:dep_meetings3} allows a worker to either attend a meeting or work with a task. 
