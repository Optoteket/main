...
If $\textit{N1a} > \textit{N1l}$ then the function were to prioritize assistants as stand-ins rather than librarians. Assistants are, however, less desired as stand-ins, due to their lack of skill to perform all task types. Therefore, it is desired to set $\textit{N1a} \leq \textit{N1l}$.
