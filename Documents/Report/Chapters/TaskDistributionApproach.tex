...
\begin{tikzpicture}[node distance = 2cm, auto]
    ...
    \node [block, left of=distribute, node distance=4cm] (redistribute) {Remove all weekends};
     ...
     \node [decision, above of=count++, node distance=2cm] (done) {Iteration > max?};
     \node[above of=savebest, left of=savebest, node distance=2cm, scale=0.1](inv){};
	...
	\node at (-2,-20.5) [above=4mm, right=2mm] {\textsc{feasibility loop}};
	\draw [color=gray!70,thick](-2,-20.5) rectangle (5,-10.5);
	\node at (-10.5,-21) [above=4mm, right=2mm] {\textsc{weekend distribution loop}};
	\draw [color=gray!70,thick](-10.5,-21) rectangle (5,-8);
