...
As was argued in Chapter \ref{chap:taskdist}, the critical part of the problem was thought to be the weekend placement part, leading to the implemented two-phase algorithm. That this is the case, is suggested by Tables \ref and \ref{}. 

The objective function value during a typical run is illustrated by Figure TODO.
