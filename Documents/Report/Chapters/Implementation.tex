...
The model described in Chapter \ref{chap:mathmod}, was implemented and run on the problem described in Chapter \ref{chap:intro} using different methods: An AMPL model and two heuristics. The first implementation was written in the mathematical modeling language AMPL and was run on a CPLEX commercial optimization software. An AMPL data file containing worker availability and worker sets was generated through exporting availability information from Excel spreadsheets to a data file together with worker data sets. Visual Basic was used for exporting.
