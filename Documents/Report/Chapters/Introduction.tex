...
The goal of this thesis is to investigate how the ten week scheduling problem for the library staff members at the Library of Norrköping can be solved using mathematical optimization methods. The goal includes:
