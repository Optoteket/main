...
All workers have a five week schedule in the same manner as the sample worker. However, in order to meet the weekend demands, illustrated in Table \ref{tab:Outer_Task_Demand}, workers have to be assigned for weekend work at different weekends. Thus, a worker's schedule can be shifted in order to make sure that all weekend demands are fulfilled.
