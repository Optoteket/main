...
The difference in objective function and constraints between the model used in AMPL and the model used in the heuristics is described by Figure \ref{fig:AMPL_vs_heur}.
...
\begin{figure}[!h]
\caption{Illustration of how the Heurstic models have been designed}
...
\begin{table}[!h]
\centering
\caption{Soft and hard constraints in the week block approach.}
\label{tab:blocks_constraints}
\begin{tabular}{|l|}
\hline
% ---------------------------------------------------------
\cellcolor{corn} \textbf{Soft Constraints} \\ \hline
First soft constraint. \\ \hline
Second... \\ \hline
% ---------------------------------------------------------
\cellcolor{corn} \textbf{Hard constraints} \\ \hline
First hard constraint. \\ \hline
Second... \\ \hline
% ---------------------------------------------------------
\cellcolor{corn} \textbf{Relaxations of constraints.} \\ \hline
First relaxed constraint. \\ \hline
Second... \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[!h]
\centering
\caption{Soft and hard constraints in the task distribution approach.}
\label{tab:task_constraints}
\begin{tabular}{|l|}
\hline
% ---------------------------------------------------------
\cellcolor{corn} \textbf{Soft Constraints} \\ \hline
- One task per day restriction. Equation \ref{constr:one_task_constraint}. \\ \hline
- Four tasks per week restriction. Equation \ref{constr:four_weekly_shifts_at_most}. \\ \hline
- One PL per week restriction. Equation \ref{constr:one_PL}. \\ \hline
- Number of PL per 10 weeks restriction. Equation \ref{constr:three_PL}. \\ \hline
- Not more than two tasks at the same shift in a week restriction. Equation \ref{constr:various_start_times}. \\ \hline
% ---------------------------------------------------------
\cellcolor{corn} \textbf{Hard constraints} \\ \hline
All other constraints in the AMPL model. \\ \hline
% ---------------------------------------------------------
\cellcolor{corn} \textbf{Relaxations of constraints.} \\ \hline
First relaxed constraint. \\ \hline
Second... \\ \hline
