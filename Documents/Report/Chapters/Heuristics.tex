...
\begin{tabular}{cccccccc}
                           & Mon                                            & Tue                                             & Wed                    & Thu                                            & Fri                    & Sat                                             & Sun                                             \\ \cline{2-8} 
\multicolumn{1}{c|}{08:00-10:00}  & \multicolumn{1}{c|}{}                          & \multicolumn{1}{c|}{\colcelltwo PL} & \multicolumn{1}{c|}{I} & \multicolumn{1}{c|}{}                          & \multicolumn{1}{c|}{I} & \multicolumn{1}{c|}{\colcelltwo HB} & \multicolumn{1}{c|}{\colcelltwo HB} \\ \cline{2-8} 
\multicolumn{1}{c|}{10:00-13:00} & \multicolumn{1}{c|}{}                          & \multicolumn{1}{c|}{\colcelltwo}   & \multicolumn{1}{c|}{}  & \multicolumn{1}{c|}{}                          & \multicolumn{1}{c|}{}  &                                                 &                                                 \\ \cline{2-6}
\multicolumn{1}{c|}{13:00-16:00} & \multicolumn{1}{c|}{}                          & \multicolumn{1}{c|}{\colcelltwo}   & \multicolumn{1}{c|}{}  & \multicolumn{1}{c|}{\colcelltwo D} & \multicolumn{1}{c|}{}  &                                                 &                                                 \\ \cline{2-6}
\multicolumn{1}{c|}{16:00-20:00} & \multicolumn{1}{c|}{\colcelltwo D} & \multicolumn{1}{c|}{}                           & \multicolumn{1}{c|}{}  & \multicolumn{1}{c|}{}                          & \multicolumn{1}{c|}{}  &                                                 &                                                 \\ \cline{2-6}
\end{tabular}
\end{table}
...
\begin{tabular}{cccccccc}
                                 & Mon                    & Tue                    & Wed                    & Thu                    & Fri                                            & Sat                                            & Sun                                            \\ \cline{2-8} 
\multicolumn{1}{c|}{08:00-10:00} & \multicolumn{1}{c|}{X} & \multicolumn{1}{c|}{X} & \multicolumn{1}{c|}{X} & \multicolumn{1}{c|}{X} & \multicolumn{1}{c|}{\cellcolor[HTML]{000000}}  & \multicolumn{1}{c|}{\colcelltwo D} & \multicolumn{1}{c|}{\colcelltwo D} \\ \cline{2-8} 
...
\multicolumn{1}{c|}{16:00-20:00} & \multicolumn{1}{c|}{}  & \multicolumn{1}{c|}{}  & \multicolumn{1}{c|}{}  & \multicolumn{1}{c|}{}  & \multicolumn{1}{c|}{\colcelltwo D} &                                                &                                                \\ \cline{2-6}
\end{tabular}
\end{table}
...
\rowcolor[HTML]{C0C0C0}
Week       & 1                         & 2                         & 3                         & 4                         & 5                          \\ \hline
Librarians & \colcelltwo 3 & 4 & \colcelltwo 4 & 4 & 4  \\ \hline
Assistants & 3 & \colcelltwo 2 & 2 & 3 & 3
\end{tabular}\\
After repair:\\
\begin{tabular}{l|llllll}
\rowcolor[HTML]{C0C0C0}
...
Table \ref{block_to_evaluate} together with Figure \ref{flow_chart_cost} show an example of week block evaluation using costs. Here, different cost contributions have to be considered before assigning it to a staff member. As the amount of already assigned staff members differ for all of the weeks, we have to consider a certain week in this example. Here we can assume we are trying to insert this block at week three when calculating the demand cost.
...
\begin{tabular}{cccccccc}
                                 & Mon                                             & Tue                    & Wed                                            & Thu                    & Fri                                            & Sat                    & Sun                    \\ \cline{2-8} 
\multicolumn{1}{c|}{08:00-10:00} & \multicolumn{1}{c|}{\colcelltwo PL} & \multicolumn{1}{c|}{I} & \multicolumn{1}{c|}{}                          & \multicolumn{1}{c|}{I} & \multicolumn{1}{c|}{}                          & \multicolumn{1}{c|}{I} & \multicolumn{1}{c|}{I} \\ \cline{2-8} 
\multicolumn{1}{c|}{10:00-13:00} & \multicolumn{1}{c|}{\colcelltwo}   & \multicolumn{1}{c|}{}  & \multicolumn{1}{c|}{}                          & \multicolumn{1}{c|}{}  & \multicolumn{1}{c|}{\colcelltwo D} &                        &                        \\ \cline{2-6}
\multicolumn{1}{c|}{13:00-16:00} & \multicolumn{1}{c|}{\colcelltwo}   & \multicolumn{1}{c|}{}  & \multicolumn{1}{c|}{\colcelltwo D} & \multicolumn{1}{c|}{}  & \multicolumn{1}{c|}{}                          &                        &                        \\ \cline{2-6}
...
\begin{tabular}{cccccccc}
   & Mon              &          &          &              &                        &                &              \\ \cline{2-2}
   \multicolumn{1}{c|}{08:00-10:00} & \multicolumn{1}{c|}{\colcelltwo PL} &                        &                                                &                        &                                                &                        &                        \\ \cline{2-2}
   \multicolumn{1}{c|}{10:00-13:00} & \multicolumn{1}{c|}{\colcelltwo}   &                        &                                                &                        &                                                &                        &                        \\ \cline{2-2}
   \multicolumn{1}{c|}{13:00-16:00} & \multicolumn{1}{c|}{\colcelltwo}   &                        &                                                &                        &                                                &                        &                        \\ \cline{2-2}
\end{tabular}
\end{table}
...
\begin{tabular}{cccccccc}
                                 & Mon                                             & Tue                    & Wed                                            & Thu                    & Fri                                            & Sat                    & Sun                    \\ \cline{2-8} 
\multicolumn{1}{c|}{08:00-10:00} & \multicolumn{1}{c|}{I} & \multicolumn{1}{c|}{\colcelltwo D} & \multicolumn{1}{c|}{I} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{\colcelltwo D} & \multicolumn{1}{c|}{I} & \multicolumn{1}{c|}{I} \\ \cline{2-8} 
...
\multicolumn{1}{c|}{16:00-20:00} & \multicolumn{1}{c|}{}  & \multicolumn{1}{c|}{}  & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{\colcelltwo D}  & \multicolumn{1}{c|}{} &         &         \\ \cline{2-6}
\end{tabular} 
\newline
...
At the end of a script iteration, there are usually a few infeasibilities left that do not get solved. To fix this, a final phase was implemented. Whenever a run is "relatively close" and it is likely to be able to find a feasible solution, the final phase is initiated. "Relatively close" means in this case that the only infeasibility left is the lack of staff members at a handful of weekday shifts. A handful would refer to an estimate of 3-8 tasks violations. In addition to being "relatively close" it has to be likely to find a feasible solution. This occurs when there are more stand-ins available than the number of demand violations for all days. The reason is because the stand-ins are expendable and can be assigned tasks in order to create a feasible solution.
...
With well chosen cost parameter values, the run will always get relatively close to feasibility and reach the final phase eventually. In case there are not enough stand-ins to fill the task violations when reaching the final phase, empty blocks will be assigned to all staff members and the solution enters the destroy and repair loop again, see Figure \ref{flow_chart}.
%
...
\begin{table}[!h]
\caption{Staff member availability when only placing weekends. The darkness of the cell's colour is proportional to the number of available staff members.}
\centering
...
\begin{tikzpicture}[node distance = 2cm , auto, every node/.style={scale=0.8}]
    %Right column
    \node [scale=0.01,node distance=0cm] (invinit) {};
    \node [block, below of=invinit, node distance =1.7cm] (distribute) {Try allocate all tasks};
    \node [block, below of=distribute, node distance =2.5cm] (workercost) {Set staff member obj fun};
    ...
    \node [decision, above of=taskcost, node distance=2.5cm] (best) {Best solution?};
