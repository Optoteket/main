...
Large neighbourhood search & Optimization method which alternately destroys and repairs the solution in order to move through the solution space. \\
...
Outer task & The tasks which are directed towards the visitors for which there is a need of scheduling. \\
