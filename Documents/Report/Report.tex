...
\newcommand{\putregnumber}[0]{LiTH-MAT-EX--2016/05--SE}
...
\definecolor{GrayLight}{gray}{0.75}
...
\begin{table}[!h]
\centering
\caption{Number of assignable unique blocks for the staff members based on their availability and qualification.}
\label{blocks_available_per_worker}
\scalebox{0.75}{
	\begin{tabular}{|c|ccc|}
	\hline
	Staff member & Weekend & Weekrest & Weekday \\ \hline
