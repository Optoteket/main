...
subject to no_evening_tasks_except_LOW{w in W, d in 1..4, j in {'Exp', 'Info','PL'}}:
	x[25,w,d,4,j] = 0;

#Worker 25 works on LOW all available Wednesdays
subject to 25_works_all_Wednesdays:
	sum{w in W} x[25,w,4,4,'LOW'] = 8;

#Workers 25 has LOW every other Monday morning and 36 the other
subject to every_other_monday_morning{w in 1..9}:
	x[36,w,1,4,'LOW'] = 1- x[25,w+1,1,1,'LOW'];
