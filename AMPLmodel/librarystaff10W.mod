...
subject to task_assign_amount_library_on_wheels2{s in {2, 3, 4}}: #not enough workers for library on wheels both s = 1 and s = 4 on thursdays
	sum{i in I} x[i,1,4,s,'LOW'] = lib_on_wheels_worker_demand[1,4,s];

subject to task_assign_amount_library_on_wheels3{w in 2..10,s in {1, 2, 3, 4}}: #not enough workers for library on wheels both s = 1 and s = 4 on thursdays
