...
\title{Scheduling of a Heterogeneous Library Staff Using Task Assignment}
...
Our current thought process for the problem is to create a basic schedule in AMPL using only constraint programming. Further development would be to create a heuristic to solve the problem making it possible to remove the use of CPLEX. The reason for this is because it is undesirable for a library to purchase the software. The current option in mind is to use Microsoft Visual Basic.

Based on inputs from the representative librarians a more robust schedule shall be produced.  
...
\pagebreak
\section*{References}
Hojati and Patil, 2010; Roberts and Escudero, 1983a, 1983b; Loucks and Jacobs, 1991; 

Roberts  and  Escudero,  1983a,
1983b
